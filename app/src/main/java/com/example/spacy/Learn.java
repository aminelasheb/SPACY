...
public class Learn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (level.equals("1")) {
            learn.setBackgroundResource(R.drawable.artf7);
            whitee=true ;

        if (Language.equals("Français")) { ident.setText("Alphabet"); ident2.setText("Appuyez sur l'astronaute"); }

        else { ident.setText("Alphabets"); ident2.setText("Tap the astronaut"); }
        }
        ...
        if (level.equals("1/2")) {
            ...
            learn.setBackgroundResource(R.drawable.artf7);
            if (Language.equals("Français")) { ident.setText("Nombres"); ident2.setText("Appuyez sur l'astronaute"); }

            else { ident.setText("Numbers"); ident2.setText("Tap the astronaut"); }
        }
        if (level.equals("2")) {
            learn.setBackgroundResource(R.drawable.artf5);
            if (Language.equals("Français")) { ident.setText("Couleurs"); ident2.setText("Appuyez sur l'astronaute"); }

            else { ident.setText("Colours"); ident2.setText("Tap the astronaut"); }
        }
        if (level.equals("2/2")) {
            learn.setBackgroundResource(R.drawable.artf6);
            if (Language.equals("Français")) { ident.setText("Formes"); ident2.setText("Appuyez sur l'astronaute"); }

            else { ident.setText("Shapes"); ident2.setText("Tap the astronaut"); }
        }
        if (level.equals("3")) {
            learn.setBackgroundResource(R.drawable.artf5);
            if (Language.equals("Français")) { ident.setText("Corps"); ident2.setText("Appuyez sur l'astronaute"); }

            else { ident.setText("Body"); ident2.setText("Tap the astronaut"); }
        }

        if (level.equals("3/2")) {
            learn.setBackgroundResource(R.drawable.artf5);
            if (Language.equals("Français")) { ident.setText("Vetements"); ident2.setText("Appuyez sur l'astronaute"); }

            else { ident.setText("Clothes"); ident2.setText("Tap the astronaut"); }
        }
        if (level.equals("4")) {
            learn.setBackgroundResource(R.drawable.artf4);
            if (Language.equals("Français")) { ident.setText("Famille"); ident2.setText("Appuyez sur l'astronaute"); }

            else { ident.setText("Familly"); ident2.setText("Tap the astronaut"); }
        }
        if (level.equals("4/2")) {
            learn.setBackgroundResource(R.drawable.artf4);
            if (Language.equals("Français")) { ident.setText("Professions"); ident2.setText("Appuyez sur l'astronaute"); }

            else { ident.setText("Jobs"); ident2.setText("Tap the astronaut"); }
        }
        if (level.equals("5")) {
        ...
        if (level.equals("6")) {
            ...
            if (Language.equals("Français")) { ident.setText("Animaux"); ident2.setText("Appuyez sur l'astronaute"); }

            else { ident.setText("Animals"); ident2.setText("Tap the astronaut"); }
        }
        if (level.equals("7")) {
            learn.setBackgroundResource(R.drawable.artf1);
            if (Language.equals("Français")) { ident.setText("Objets"); ident2.setText("Appuyez sur l'astronaute"); }

            else { ident.setText("Objects"); ident2.setText("Tap the astronaut"); }
        }



       if (whitee) {ident2.setTextColor(Color.WHITE);ident.setTextColor(Color.WHITE);}

        vpHorizontal = findViewById(R.id.vpp_horizontal3fb);
//        if ( ((level.equals("1")) && languageLearn.equals("An")) || ((level.equals("1")) && languageLearn.equals("Fr")) ) {
...
//        toast.show();
        ...
        im.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mMediaPlayer = MediaPlayer.create(Learn.this, vocals[vpHorizontal.getCurrentItem()]);

...
//        score.setText("Score :"+userscore+"/"+questionBank.length);
        ...
        android.widget.FrameLayout ooptionA = findViewById(R.id.Opptionn1);
        android.widget.FrameLayout ooptionB = findViewById(R.id.Ooption22);
        android.widget.FrameLayout ooptionC = findViewById(R.id.Opption33);
        android.widget.FrameLayout ooptionD = findViewById(R.id.Opption44);
    ...
    private void updateQuestion() {
        FrameLayout ooptionA = findViewById(R.id.Opptionn1);
        android.widget.FrameLayout ooptionB = findViewById(R.id.Ooption22);
        android.widget.FrameLayout ooptionC = findViewById(R.id.Opption33);
        android.widget.FrameLayout ooptionD = findViewById(R.id.Opption44);
        Reponse=false;

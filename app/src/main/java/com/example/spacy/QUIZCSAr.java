...
String id;
    ...
    private final answerClass[] questionBank = new answerClass[]{
            ...
            new answerClass(2, R.drawable.yellowquiz, R.string.question90_A, R.string.question90_B
                    , R.string.question90_C, R.string.question90_D, R.string.answer90),
            new answerClass(5, R.raw.orangear, R.drawable.blackquiz, R.drawable.whitequiz
                    , R.drawable.orangequiz, R.drawable.bleuquiz, R.drawable.orangequiz),
            new answerClass(4, R.string.question91, R.drawable.violetquiz, R.drawable.greenquiz
            ...
            new answerClass(2, R.drawable.pinkquiz, R.string.question90_B, R.string.question90_A
                    , R.string.question90_C, R.string.question90_D, R.string.question90_B),
            new answerClass(2, R.drawable.star, R.string.question91_D, R.string.question91_C
                    , R.string.question92_C, R.string.question91_B, R.string.question92_C),
            new answerClass(5, R.raw.whitear, R.drawable.blackquiz, R.drawable.orangequiz
                    , R.drawable.whitequiz, R.drawable.bleuquiz, R.drawable.whitequiz),
            new answerClass(5, R.raw.trianglear, R.drawable.hexagon, R.drawable.square
                    , R.drawable.circle, R.drawable.triangle, R.drawable.triangle),
    ...
    private void updateQuestion() {
        ...
        if (currentIndex == 0) {
            ...
            if (GM.equals("MAIL")||GM.equals("GOOGLE")) {
                ...
                editor.putString("Arabe2", userscore+"");
                editor.commit();
            }
            ...
            alert.setPositiveButton("Retour ", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    Intent intent = new Intent(QUIZCSAr.this, CSQ.class);
                    intent.putExtra("language", languagess);

...
public class
Quiz3AN extends AppCompatActivity {
    ...
    private final answerClass[] questionBank = new answerClass[]{
            ...
            new answerClass(4, R.string.question107_a, R.drawable.face, R.drawable.pied
                    , R.drawable.nose, R.drawable.mainn, R.drawable.face),
            new answerClass(3, R.raw.boot,R.string.question106_c,R.string.question107_b,

                    R.string.question105_b,R.string.question107_c,R.string.question107_c ),
            new answerClass(2, R.drawable.pied, R.string.question106_b,R.string.question107_d,
        ...
        if ((questionBank[currentIndex].getQc() == 1) || (questionBank[currentIndex].getQc() == 4)) {
            ...
            Questionimagee.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    releaseMediaPlayer();
                    mMediaPlayer = MediaPlayer.create(Quiz3AN.this, questionBank[currentIndex].getQuestionid());
                    mMediaPlayer.start();

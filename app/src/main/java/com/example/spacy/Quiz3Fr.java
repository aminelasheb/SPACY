...
public class Quiz3Fr extends AppCompatActivity {
...
// 1 : Question text and replies text
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.quiz_clothes_fr);
        ...
        if ((questionBank[currentIndex].getQc() == 1) || (questionBank[currentIndex].getQc() == 4)) {
            ...
            Questionimagee.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    releaseMediaPlayer();
                    mMediaPlayer = MediaPlayer.create(Quiz3Fr.this, questionBank[currentIndex].getQuestionid());
                    mMediaPlayer.start();

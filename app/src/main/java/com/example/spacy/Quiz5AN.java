...
public class Quiz5AN extends AppCompatActivity {
...
String id;
    ...
    private final answerClass[] questionBank = new answerClass[]{
            ...
            new answerClass(2, R.drawable.orangee, R.string.question5_000,
                    R.string.question5_001, R.string.question5_002, R.string.question5_004, R.string.question5_004),
            new answerClass(5, R.raw.carottean, R.drawable.tomatte, R.drawable.carotte
                    , R.drawable.pommedeterre, R.drawable.champignon, R.drawable.carotte),
            new answerClass(4, R.string.question5_000, R.drawable.fraise, R.drawable.pomme
                    , R.drawable.bannane, R.drawable.maiis, R.drawable.bannane),
            new answerClass(3, R.raw.orangean, R.string.question5_001, R.string.question5_004,
                    R.string.question5_005, R.string.question5_006, R.string.question5_004),
            new answerClass(2, R.drawable.pommedeterre, R.string.question5_007, R.string.question5_008,
                    R.string.question5_009, R.string.question5_010, R.string.question5_010),
            new answerClass(5, R.raw.kiwian, R.drawable.kiwi, R.drawable.pastheque
                    , R.drawable.poire, R.drawable.datte, R.drawable.kiwi),
            ...
            new answerClass(2, R.drawable.pastheque, R.string.question5_010,
                    R.string.question5_009, R.string.question5_008, R.string.question5_00332, R.string.question5_00332),
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz5_an);


//        questionNumber.setText(qn+"/"+questionBank.length+"Question");
//        score.setText("Score :"+userscore+"/"+questionBank.length);
        android.widget.FrameLayout ooptionA = findViewById(R.id.Opttion1);
        ...
        optionA = findViewById(R.id.Option51);
        optionB = findViewById(R.id.Option52);
        optionC = findViewById(R.id.Option53);
        optionD = findViewById(R.id.Option54);
        optionAi = findViewById(R.id.imageView5i1);
        optionBi = findViewById(R.id.imageView5i2);
        optionCi = findViewById(R.id.imageView5i3);
        optionDi = findViewById(R.id.imageView5i4);
        optionT = findViewById(R.id.TextOptions5);
        optionI = findViewById(R.id.optioni5);

        question = findViewById(R.id.Questioon5an);
        Questionimagee = findViewById(R.id.imagee5an);
        questionNumber = findViewById(R.id.Question5an);
        score = findViewById(R.id.score5);
        progressBar = findViewById(R.id.progress_bar5);
        checkout1 = findViewById(R.id.select_option5an);
        checkout2 = findViewById(R.id.CorrectAnswer5an);
        ...
        if ((questionBank[currentIndex].getQc() == 1) || (questionBank[currentIndex].getQc() == 4)) {
            ...
            Questionimagee.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    releaseMediaPlayer();
                    mMediaPlayer = MediaPlayer.create(Quiz5AN.this, questionBank[currentIndex].getQuestionid());
                    mMediaPlayer.start();

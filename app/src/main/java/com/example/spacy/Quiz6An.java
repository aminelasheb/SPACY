...
public class Quiz6An extends AppCompatActivity {
...
String id;
    ...
    private final answerClass[] questionBank = new answerClass[]{
            ...
            new answerClass(2, R.drawable.snake, R.string.question48_A, R.string.question48_B
                    , R.string.question48_C, R.string.question48_D, R.string.answer48),
            new answerClass(5, R.raw.cow, R.drawable.cow, R.drawable.lion
                    , R.drawable.monkey, R.drawable.fox, R.drawable.cow),
            new answerClass(4, R.string.question43, R.drawable.rabbit, R.drawable.snake
                    , R.drawable.giraffe, R.drawable.gorilla, R.drawable.rabbit),
            new answerClass(3, R.raw.elephant, R.string.question49_A, R.string.question49_B
                    , R.string.question49_C, R.string.question49_D, R.string.answer49),
            new answerClass(2, R.drawable.cat, R.string.question48a_A, R.string.question48a_B
...
// 1 : Question text and replies text
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz6_an);
        ...
        if ((questionBank[currentIndex].getQc() == 1) || (questionBank[currentIndex].getQc() == 4)) {
            ...
            Questionimagee.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    releaseMediaPlayer();
                    mMediaPlayer = MediaPlayer.create(Quiz6An.this, questionBank[currentIndex].getQuestionid());
                    mMediaPlayer.start();

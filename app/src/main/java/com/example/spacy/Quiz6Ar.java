...
public class Quiz6Ar extends AppCompatActivity {
...
String id;
    ...
    private final answerClass[] questionBank = new answerClass[]{
            ...
            new answerClass(2, R.drawable.snake, R.string.question58_A, R.string.question58_B
                    , R.string.question58_C, R.string.question58_D, R.string.answer58),
            new answerClass(5, R.raw.lionar, R.drawable.cow, R.drawable.lion
                    , R.drawable.monkey, R.drawable.fox, R.drawable.lion),
            new answerClass(4, R.string.question63, R.drawable.rabbit, R.drawable.snake
                    , R.drawable.giraffe, R.drawable.gorilla, R.drawable.giraffe),
            new answerClass(3, R.raw.foxar, R.string.question69_A, R.string.question69_B
                    , R.string.question69_C, R.string.question69_D, R.string.answer69),
            new answerClass(2, R.drawable.horse, R.string.question68_A, R.string.question68_B
                    , R.string.question68_C, R.string.question68_D, R.string.answer68),
            new answerClass(5, R.raw.rabitar, R.drawable.dog, R.drawable.cow
                    , R.drawable.rabbit, R.drawable.giraffe, R.drawable.rabbit),

            new answerClass(2, R.drawable.elepant, R.string.question58_A, R.string.question58_B
                    , R.string.question58_C, R.string.question58_D, R.string.question58_B),
            new answerClass(3, R.raw.horsear, R.string.question68_B, R.string.question63
                    , R.string.question68_C, R.string.question69_B, R.string.question68_B),
            new answerClass(5, R.raw.catar, R.drawable.cat, R.drawable.elepant
                    , R.drawable.monkey, R.drawable.giraffe, R.drawable.cat),
            new answerClass(2, R.drawable.dog, R.string.question69_B, R.string.question58_B
                    , R.string.question68_D, R.string.question58_D, R.string.question69_B),
...
// 1 : Question text and replies text
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_animals_quiz_ar);
        ...
        if ((questionBank[currentIndex].getQc() == 1) || (questionBank[currentIndex].getQc() == 4)) {
            ...
            Questionimagee.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    releaseMediaPlayer();
                    mMediaPlayer = MediaPlayer.create(Quiz6Ar.this, questionBank[currentIndex].getQuestionid());
                    mMediaPlayer.start();
    ...
    private void updateQuestion() {
        ...
        if (currentIndex == 0) {
            ...
            if (GM.equals("MAIL")||GM.equals("GOOGLE")) {
                ...
                editor.putString("Arabe6", userscore+"");
                editor.commit();
            }
            AlertDialog.Builder alert = new AlertDialog.Builder(this);
            alert.setTitle("اللعبة انتهت!");
            ...
            alert.setNegativeButton("اعادة اللعبة", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    score.setText("النيجة :" + userscore + "/" + questionBank.length);
                    questionNumber.setText(qn + "/" + questionBank.length + " السؤال");

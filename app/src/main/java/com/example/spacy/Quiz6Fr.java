...
public class Quiz6Fr extends AppCompatActivity {
...
String id;
    ...
    private final answerClass[] questionBank = new answerClass[]{
            ...
            new answerClass(2, R.drawable.panda, R.string.question38_A, R.string.question38_B
                    , R.string.question38_C, R.string.question38_D, R.string.answer38),
            new answerClass(5, R.raw.lionfr, R.drawable.cow, R.drawable.lion
                    , R.drawable.monkey, R.drawable.fox, R.drawable.lion),
            new answerClass(4, R.string.question33, R.drawable.rabbit, R.drawable.snake
                    , R.drawable.giraffe, R.drawable.gorilla, R.drawable.gorilla),
            new answerClass(3, R.raw.catfr, R.string.question29_A, R.string.question29_B
                    , R.string.question29_C, R.string.question29_D, R.string.answer29),
            new answerClass(2, R.drawable.monkey, R.string.question28_A, R.string.question28_B
                    , R.string.question28_C, R.string.question28_D, R.string.answer28),
            new answerClass(5, R.raw.cowfr, R.drawable.dog, R.drawable.cow
                    , R.drawable.cat, R.drawable.giraffe, R.drawable.cow),
            new answerClass(2, R.drawable.elepant, R.string.question29_D, R.string.question29_C
                    , R.string.question28_D, R.string.question28_A, R.string.question29_C),
            new answerClass(3, R.raw.horsefr, R.string.question29_B, R.string.question38_D
                    , R.string.question38_C, R.string.question29_D, R.string.question29_B),
            new answerClass(5, R.raw.elephantfr, R.drawable.elepant, R.drawable.horse
                    , R.drawable.monkey, R.drawable.panda, R.drawable.elepant),
            new answerClass(2, R.drawable.snake, R.string.question28_D8, R.string.question28_B
                    , R.string.question28_C, R.string.question28_D, R.string.question28_D8),
...
// 1 : Question text and replies text
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_animals_quiz_fr);
        ...
        if ((questionBank[currentIndex].getQc() == 1) || (questionBank[currentIndex].getQc() == 4)) {
            ...
            Questionimagee.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    releaseMediaPlayer();
                    mMediaPlayer = MediaPlayer.create(Quiz6Fr.this, questionBank[currentIndex].getQuestionid());
                    mMediaPlayer.start();
    ...
    private void updateQuestion() {
        ...
        if (currentIndex == 0) {
            ...
            if (GM.equals("MAIL")||GM.equals("GOOGLE")) {
                ...
                editor.putString("Français6", userscore+"");
                editor.commit();
            }

...
public class quiz7_arabe extends AppCompatActivity {
...
String id;
    ...
    private final answerClass[] questionBank = new answerClass[]{
            ...
            new answerClass(2, R.drawable.backpack, R.string.option1aa, R.string.option2bb
                    , R.string.option3cc, R.string.option4dd, R.string.answerqc1mm),
            new answerClass(5, R.raw.kitab, R.drawable.pillow, R.drawable.chair
                    , R.drawable.bed, R.drawable.book, R.drawable.book),
            new answerClass(4, R.string.option12qq, R.drawable.backpack, R.drawable.hammer
                    , R.drawable.clock, R.drawable.book, R.drawable.clock),
            new answerClass(3, R.raw.kora, R.string.option5ee, R.string.option6ff
                    , R.string.option7gg, R.string.option8hh, R.string.answerqc2nn),
            new answerClass(2, R.drawable.keys, R.string.option9ii, R.string.option10jj
                    , R.string.option11kk, R.string.option13ll, R.string.answerqc3oo),
            new answerClass(5, R.raw.hidae, R.drawable.shoes, R.drawable.ball
                    , R.drawable.clock, R.drawable.pc, R.drawable.shoes),

            new answerClass(2, R.drawable.book, R.string.option13ll, R.string.option10jj
                    , R.string.option8hh, R.string.option2bb, R.string.option13ll),
            new answerClass(5, R.raw.sarir, R.drawable.bed, R.drawable.keys
                    , R.drawable.backpack, R.drawable.clock, R.drawable.bed),
            new answerClass(3, R.raw.mitra9a, R.string.option5ee, R.string.option8hh
                    , R.string.option7gg, R.string.option3cc, R.string.option8hh),
            new answerClass(2, R.drawable.chair, R.string.option10jj, R.string.option12qq
                    , R.string.option10jj, R.string.option111kk, R.string.option111kk),
        ...
        if ((questionBank[currentIndex].getQc() == 1) || (questionBank[currentIndex].getQc() == 4)) {
            ...
            Questionimagee.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    releaseMediaPlayer();
                    mMediaPlayer = MediaPlayer.create(quiz7_arabe.this, questionBank[currentIndex].getQuestionid());
                    mMediaPlayer.start();
    ...
    private void updateQuestion() {
        ...
        if (currentIndex == 0) {
            ...
            if (GM.equals("MAIL")||GM.equals("GOOGLE")) {
                ...
                editor.putString("Arabe7", userscore+"");
                editor.commit();
            }

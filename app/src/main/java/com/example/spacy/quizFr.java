...
String id ;
    ...
    private final answerClass[] questionBank = new answerClass[]{
            ...
            new answerClass(1, R.string.question11, R.string.question11_A, R.string.question11_B
                    , R.string.question11_C, R.string.question11_D, R.string.answer11),
            new answerClass(3, R.raw.efr, R.string.question12_A, R.string.question12_B
                    , R.string.question12_C, R.string.question12_D, R.string.answer12),
            new answerClass(4, R.string.question23, R.drawable.threee, R.drawable.nine
                    , R.drawable.four, R.drawable.zero, R.drawable.nine),
            new answerClass(2, R.drawable.eightq, R.string.question19_A, R.string.question19_B
                    , R.string.question19_C, R.string.question19_D, R.string.answer19),
            new answerClass(1, R.string.question18, R.string.question18_A, R.string.question18_B
                    , R.string.question18_C, R.string.question18_D, R.string.answer18),
        ...
        if ((questionBank[currentIndex].getQc() == 1) || (questionBank[currentIndex].getQc() == 4)) {
            ...
            Questionimagee.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    releaseMediaPlayer();
                    mMediaPlayer = MediaPlayer.create(quizFr.this, questionBank[currentIndex].getQuestionid());
                    mMediaPlayer.start();
